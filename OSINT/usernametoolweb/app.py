...
def main(): 
    ...
    st.set_page_config(page_title="OSINT Username Finder", page_icon="🔍", layout="wide") 
    ...
    st.sidebar.info("This tool performs OSINT (Open Source Intelligence) searches for usernames. Use responsibly and ensure compliance with all applicable laws.") 
...
if __name__ == "__main__": 
    ...
    main() 
st.sidebar.info('Powered by 051N773@M')
