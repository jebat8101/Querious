...
# Define the main function for the Email Checker app
        ...
        if email and is_valid_email(email):
            ...
            with st.spinner("Processing..."):
                try:
                    ...
                    raw_output_file = os.path.join(results_dir, f"{email}_holehe_result.txt")
                    with open(raw_output_file, 'w') as raw_file:
                        raw_file.write(result.stdout)

                    # Filter the output
                    filtered_output_file = os.path.join(results_dir, f"{email}_filtered_result.txt")
                    ...
                    if filtered_file:
                        ...
                        st.download_button(
                            ...
                            file_name=os.path.basename(filtered_output_file),
                            mime="text/plain",
                        )
